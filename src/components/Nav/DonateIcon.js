...
const DonateIcon = ({ fill }) =>(
    <svg xmlns="http://www.w3.org/2000/svg" width="338.406" height="262.407" viewBox="0 0 338.406 262.407" fill={ fill } className="donate-icon">
    <g id="Group_43" data-name="Group 43" transform="translate(-578.492 -1825.868)">
        ...
        <g id="iconfinder_00-ELASTOFONT-STORE-READY_rub_2703067-2" data-name="iconfinder_00-ELASTOFONT-STORE-READY_rub_2703067" transform="translate(765.595 1914.395) rotate(-41)">
            <path id="Path_38-2" data-name="Path 38" d="M21,1A20,20,0,1,0,41,21,20.022,20.022,0,0,0,21,1Zm0,37.5A17.5,17.5,0,1,1,38.5,21,17.519,17.519,0,0,1,21,38.5Z" fill={ fill }/>
